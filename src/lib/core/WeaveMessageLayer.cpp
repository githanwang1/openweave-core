 ...
 *
 * @details
 *   This function generates 64-bit locally unique Weave device Id. This function uses cryptographically strong
 *   random data source to guarantee uniqueness of generated value. Note that bit 57 of the generated Weave
 *   device Id is set to 1 to indicate that generated Weave device Id is locally (not globally) unique.
 *
